...
output_dir="/media/orlab/437478a6-2666-4549-903d-18e9d7d1c34f/orlab/Quocdat/SLSCM Lab/projects/output/"
...
for instance in $instances; do
  ...
  timeout 3600 ./build/RV-FSTSP -i "$input_file" --mode 31 -o "$output_dir" | tee "$output_file"
